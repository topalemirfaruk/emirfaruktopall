...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://itsfoss.com/content/images/2025/12/swiss-data-protection-group-resolution.png")}" alt="Veri Gizliliği ve Bulut" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://itsfoss.com/content/images/2025/12/german-state-boots-microsoft.png")}" alt="Almanya Bayrağı ve Teknoloji" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://ittech-pulse.com/wp-content/uploads/2025/12/Red-Hat-Accelerates-AI-Trust-and-Security-with-Chatterbox-Labs-Acquisition.png")}" alt="Yapay Zeka ve Güvenlik" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://itsfoss.com/content/images/2025/12/denmark-road-transport-authority-ditches-microsoft.png")}" alt="Kopenhag Şehri" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://i0.wp.com/9to5linux.com/wp-content/uploads/2025/12/lk617e.webp?resize=1400%2C800&ssl=1")}" alt="Linux Kod Ekranı" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://www.amazic.com/media/omnyfy/post/media/Unlimited_access_to_Docker_Hardened_Images_Because_security_should_be_affordable_always.jpg")}" alt="Konteyner ve Nakliye" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
...
<div class="flex justify-start my-6">
  <img src="${optimizeImage("https://images.unsplash.com/photo-1558494949-efc5270f9c23")}" alt="Veritabanı Sunucuları" class="w-full max-w-[380px] aspect-video object-cover rounded-xl shadow-md border border-[#22c55e]/20" />
</div>
